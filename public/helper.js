...
function generateBoatIcon(color){
    return L.divIcon({
    html: `<svg 
 height="24"
  viewBox="0 0 512 512"
...
function numberToDateString(date){
...
<div class="form-check form-switch">
            ...
            <div class="accordion -flush" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="heading`+value+`">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapse`+value+`" aria-expanded="false" aria-controls="collapse`+value+`">
                            Problems
                        </button>
                    </h2>
                    <div id="collapse`+value+`" class="accordion-collapse collapse " aria-labelledby="heading`+value+`"
                         data-bs-parent="#accordionExample">
                        <div class="accordion-body" id="problems`+value+`">
